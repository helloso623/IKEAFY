const PARTS = [
  ...
  },
  {
    ...
    sku: "GEN-ROUND-PED-900",
    ikeaArticle: null,
    name: "Round pedestal table 90 cm",
    brand: "Generic",
    category: "furniture",
    shape: "round-pedestal-table",
    cost: 48,
    store: "generic",
    storeUrl: "",
    includedIn: [],
    dimsMm: { x: 900, y: 900, z: 740 },
    massG: 18400,
    material: "furniture plywood",
    color: "#d5aa72",
    texture: "oak-open",
    printable: false,
    strengthMpa: 30,
    ...
    specs: {
      ...
      geometry: {
        ...
        tabletop: { type: "cylinder", radiusMm: 450, heightMm: 36, radialSegments: 64 },
        pedestal: {
          type: "cylinder",
          radiusTopMm: 55,
          radiusBottomMm: 85,
        ...
        base: { type: "cylinder", radiusMm: 250, heightMm: 50, radialSegments: 64 },
      },
    },
    note: "Editable circular top with one tapered central pedestal and a round disc base.",
  },
  {
    id: "generic-stool",
    sku: "GEN-STOOL-400",
